...
printUsage() {
  ...
  echoStderr ""
  echoStderr "Copy the TSTool Google plugin installer files to the Amazon S3 static website folder:"
...
printVersion() {
  ...
  echoStderr ""
  echoStderr "TSTool Google Plugin"
...
logInfo ""
logInfo "${installerUpdateCount} TSTool Google plugin installers were uploaded to Amazon S3 location:"
logInfo ""
logInfo "  ${s3FolderUrl}"
logInfo "  ${gpDownloadUrl}"
logInfo ""
logInfo "Next steps are to do the following:"
logInfo "  - Visit the following folder to download the TSTool Google plugin:"
logInfo "      ${gpDownloadUrl}/"
logInfo ""
